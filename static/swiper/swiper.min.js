      ...
      if (void 0 !== i) {
        ...
        for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), P = 0; P < d; P += 1) {
          ...
          if ("none" !== k.css("display")) {
            ...
            l[P] && (l[P].swiperSlideSize = T), u.push(T), t.centeredSlides ? ((b = b + T / 2 + w / 2 + g), 0 === w && 0 !== P && (b = b - i / 2 - g), 0 === P && (b = b - i / 2 - g), Math.abs(b) < 0.001 && (b = 0), t.roundLengths && (b = Math.floor(b)), y % t.slidesPerGroup == 0 && p.push(b), c.push(b)) : (t.roundLengths && (b = Math.floor(b)), y % t.slidesPerGroup == 0 && p.push(b), c.push(b), (b = b + T + g)), (e.virtualSize += T + g), (w = T), (y += 1)
          }
        }
